...
export const alignValue = oneOf(enums(alignEnum), def("alignValue"));

export const anchorValue = oneOf(enums(anchorEnum), def("anchorValue"));

export const baselineValue = oneOf(enums(baselineEnum), def("baselineValue"));

export const booleanValue = oneOf(booleanType, def("booleanValue"));

export const colorValue = oneOf(nullType, stringType, def("colorValue"));

export const dashArrayValue = oneOf(array(numberType), def("arrayValue"));
...
export const numberValue = oneOf(numberType, def("numberValue"));

export const orientValue = oneOf(enums(orientEnum), def("orientValue"));

export const stringValue = oneOf(stringType, def("stringValue"));

export const booleanOrNumberOrSignal = oneOf(
  booleanType,
  numberType,
  signalRef
);
