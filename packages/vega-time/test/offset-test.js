...
tape("timeOffset computes local date offsets", (t) => {
  ...
  t.equal(
    +vega.timeOffset("minutes", local(2012), 2),
    +local(2012, 0, 1, 0, 2)
  );
  t.equal(
    +vega.timeOffset("seconds", local(2012)),
    +local(2012, 0, 1, 0, 0, 1)
  );
  t.equal(
    +vega.timeOffset("seconds", local(2012), 2),
    +local(2012, 0, 1, 0, 0, 2)
  );
  t.equal(
    +vega.timeOffset("milliseconds", local(2012)),
    +local(2012, 0, 1, 0, 0, 0, 1)
  );
  t.equal(
    +vega.timeOffset("milliseconds", local(2012), 2),
    +local(2012, 0, 1, 0, 0, 0, 2)
  );
  t.end();
});
...
tape("utcOffset computes utc date offsets", (t) => {
  ...
  t.equal(
    +vega.utcOffset("milliseconds", utc(2012)),
    +utc(2012, 0, 1, 0, 0, 0, 1)
  );
  t.equal(
    +vega.utcOffset("milliseconds", utc(2012), 2),
    +utc(2012, 0, 1, 0, 0, 0, 2)
  );
  t.end();
});
