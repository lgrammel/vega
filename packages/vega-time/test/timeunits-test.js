...
tape("timeUnits standardizes time units", (t) => {
  ...
  t.deepEqual(vega.timeUnits(["year", "month", "date"]), [
    "year",
    "month",
    "date",
  ]);
  t.deepEqual(vega.timeUnits(["year", "date", "month"]), [
    "year",
    "month",
    "date",
  ]);
  t.deepEqual(vega.timeUnits(["date", "month", "year"]), [
    "year",
    "month",
    "date",
  ]);
  ...
  t.deepEqual(vega.timeUnits(["hours", "minutes", "seconds"]), [
    "hours",
    "minutes",
    "seconds",
  ]);
  t.deepEqual(vega.timeUnits(["hours", "seconds", "minutes"]), [
    "hours",
    "minutes",
    "seconds",
  ]);
  t.deepEqual(vega.timeUnits(["seconds", "minutes", "hours"]), [
    "hours",
    "minutes",
    "seconds",
  ]);
