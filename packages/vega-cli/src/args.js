...
To load data, you may need to set a base directory:
  ...
  args
    ...
    .describe(
      "l",
      'Level of log messages written to stderr. One of "error", "warn" (default), "info", or "debug".'
    );
  ...
  args
    ...
    .describe(
      "c",
      "Vega config object. Either a JSON file or a .js file that exports the config object."
    );
  ...
  args
    ...
    .describe(
      "f",
      "Number format locale descriptor. Either a JSON file or a .js file that exports the locale object."
    );
