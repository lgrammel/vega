...
// $ExpectError
spec = {
  signals: [{ name: "foo", on: [{ events: "mousedown", encode: null }] }],
};

// $ExpectError
spec = {
  signals: [{ name: "foo", on: [{ events: "mousedown", encode: false }] }],
};
...
// $ExpectError
spec = {
  signals: [{ name: "foo", on: [{ events: "mousedown", encode: [] }] }],
};
...
// $ExpectError
spec = {
  signals: [{ name: "foo", on: [{ events: "mousedown", update: null }] }],
};

// $ExpectError
spec = {
  signals: [{ name: "foo", on: [{ events: "mousedown", update: false }] }],
};
...
// $ExpectError
spec = {
  signals: [{ name: "foo", on: [{ events: "mousedown", update: [] }] }],
};
...
spec = {
  signals: [
    { name: "foo", on: [{ events: "mousedown", update: "1", force: null }] },
  ],
};
...
spec = {
  signals: [
    { name: "foo", on: [{ events: "mousedown", update: "1", force: 1 }] },
  ],
};
...
spec = {
  signals: [
    {
      name: "foo",
      on: [{ events: "mousedown", update: "1", force: "string" }],
    },
  ],
};
...
spec = {
  signals: [
    { name: "foo", on: [{ events: "mousedown", update: "1", force: {} }] },
  ],
};
