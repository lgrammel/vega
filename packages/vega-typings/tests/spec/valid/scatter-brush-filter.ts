    ...
    { name: "brush", update: 'vlSelectionResolve("brush_store")' },
    {
      ...
      on: [
        ...
        },
        {
          events: { scale: "x" },
          update:
            "span(brush_x) && !(+invert('x', brush_x)[0] === +brush_yearmonth_date[0] && +invert('x', brush_x)[1] === +brush_yearmonth_date[1]) ? [scale('x', brush_yearmonth_date[0]), scale('x', brush_yearmonth_date[1])] : brush_x",
        },
        {
        ...
        },
        {
          ...
          update:
            "clampRange(zoomLinear(brush_x, brush_zoom_anchor.x, brush_zoom_delta), 0, width)",
        },
      ],
    },
    {
      ...
      on: [
        {
          ...
          update:
            'brush_yearmonth_date ? {unit: "layer_0", fields: brush_tuple_fields, values: [brush_yearmonth_date]} : null',
        },
      ],
    },
    {
      ...
      on: [
        {
          ...
          update:
            "{x: brush_translate_anchor.x - x(unit), y: brush_translate_anchor.y - y(unit)}",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      encode: {
        update: {
          ...
          tooltip: {
            signal:
              '{"date (year-month)": timeFormat(datum["yearmonth_date"], \'%b %Y\'), "Sum of count": format(datum["sum_count"], "")}',
          },
          ...
          defined: {
            signal:
              'datum["yearmonth_date"] !== null && !isNaN(datum["yearmonth_date"]) && datum["sum_count"] !== null && !isNaN(datum["sum_count"])',
          },
        },
      },
    },
