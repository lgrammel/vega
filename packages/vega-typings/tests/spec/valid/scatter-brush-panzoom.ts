      ...
      on: [
        {
          ...
          update:
            "{x: x(unit), y: y(unit), extent_x: slice(brush_x), extent_y: slice(brush_y)}",
        },
      ],
    },
    {
      ...
      on: [
        {
          ...
          update:
            "panLinear(grid_translate_anchor.extent_x, -grid_translate_delta.x / width)",
        },
        {
          events: { signal: "grid_zoom_delta" },
          update:
            'zoomLinear(domain("x"), grid_zoom_anchor.x, grid_zoom_delta)',
        },
      ],
    },
    {
      ...
      on: [
        {
          events: { signal: "grid_translate_delta" },
          update:
            "panLinear(grid_translate_anchor.extent_y, grid_translate_delta.y / height)",
        },
        {
          events: { signal: "grid_zoom_delta" },
          update:
            'zoomLinear(domain("y"), grid_zoom_anchor.y, grid_zoom_delta)',
        },
      ],
    },
    {
      ...
      on: [
        {
          ...
          update:
            '{x: x(unit), y: y(unit), extent_x: domain("x"), extent_y: domain("y")}',
        },
      ],
    },
    {
      ...
      on: [
        {
          ...
          update:
            "{x: grid_translate_anchor.x - x(unit), y: grid_translate_anchor.y - y(unit)}",
        },
      ],
    },
    {
