...
export const spec: Spec = {
    ...
    },
    {
      ...
      transform: [
        ...
        },
        {
          ...
          field: "time",
          as: [
            "bin_maxbins_30_minstep_1_time",
            "bin_maxbins_30_minstep_1_time_end",
          ],
          ...
          on: [
            {
              events: {
                ...
                type: "mousedown",
                filter: [
                  '!event.item || event.item.mark.name !== "time_brush"',
                ],
              },
            ...
            },
            {
              ...
              update:
                '[scale("concat_0_x", time_time[0]), scale("concat_0_x", time_time[1])]',
            },
            {
          ...
          on: [
            {
              ...
              update:
                'time_x[0] === time_x[1] ? null : invert("concat_0_x", time_x)',
            },
          ],
        },
        {
          ...
          on: [
            {
              ...
              update:
                "{x: time_translate_anchor.x - x(unit), y: time_translate_anchor.y - y(unit)}",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          encode: {
            ...
            update: {
              ...
              stroke: [
                { test: "time_x[0] !== time_x[1]", value: "white" },
                { value: null },
              ],
            },
          },
  ...
  scales: [
    ...
    },
    {
      ...
      domain: {
        signal:
          "[concat_1_bin_maxbins_30_time_bins.start, concat_1_bin_maxbins_30_time_bins.stop]",
      },
